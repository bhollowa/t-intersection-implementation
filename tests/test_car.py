import unittest
from models.car import Car, ExceedCarMaximumSpeedError, StopSpeedReached
...
class TestCar(unittest.TestCase):
    ...
    def test_move_car(self):
        ...
        new_car = Car(absolute_speed=10, direction=Direction(self.degrees, -self.degrees))
        new_car.move(5.0, new_car.SECONDS)
    ...
    def test_accelerate_car(self):
        ...
        new_car = Car(direction=Direction(self.degrees, self.degrees))
    ...
    def test_decelerate_car(self):
        ...
        new_car = Car(direction=Direction(-self.degrees, -self.degrees), absolute_speed=30)
