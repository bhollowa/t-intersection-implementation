...
class TestCar(unittest.TestCase):
    ...
    def test_move_car(self):
        ...
        self.car.move(5.0, self.car.TIME_STEP)
        self.assertEqual(self.car.pos_x, 0)
        self.assertEqual(self.car.pos_y, 0)

        new_car = Car(absolute_speed=17)
        new_car.move(5.0, new_car.TIME_STEP)
    ...
    def test_accelerate_car(self):
        ...
        self.car.accelerate(1.0, self.car.TIME_STEP)
        ...
        new_car.accelerate(5.0, new_car.TIME_STEP)
        ...
        self.assertRaises(Car.ExceedCarMaximumSpeedError, new_car.accelerate, 40, new_car.TIME_STEP)

    def test_decelerate_car(self):

        self.assertRaises(Car.StopSpeedReached, self.car.brake_decelerate, 1, self.car.TIME_STEP)

        new_car = Car(absolute_speed=30)
        new_car.brake_decelerate(1, new_car.TIME_STEP)
        self.assertEqual(new_car.absolute_speed, 26)
        self.assertEqual(new_car.pos_x, 28)
        self.assertEqual(new_car.pos_y, 0)

        new_car.brake_decelerate(5, new_car.TIME_STEP)
        ...
        new_car.brake_decelerate(7, new_car.TIME_STEP)
    ...
    def test_start_go_stop(self):
        ...
        self.car.accelerate(4, self.car.TIME_STEP)
        self.car.move(10, self.car.TIME_STEP)
        self.car.brake_decelerate(3, self.car.TIME_STEP)
        self.assertEqual(self.car.absolute_speed, 0)
    ...
    def test_turn_car(self):
        ...
        self.car.turn(1, self.car.TIME_STEP, 45)
        self.assertEqual(self.car.absolute_speed, 0)
        self.assertEqual(self.car.direction, Direction())
        self.assertEqual(self.car.pos_x, 0)
        self.assertEqual(self.car.pos_y, 0)

        self.car.accelerate(5, self.car.TIME_STEP)
        self.assertRaises(Car.ExceedWheelTurningException, self.car.turn, 5, self.car.TIME_STEP, 90)
        self.assertRaises(Car.ExceedTurningSpeedException, self.car.turn, 5, self.car.TIME_STEP, 45)

        new_car = Car(absolute_speed=10)
        new_car.turn(0.627, self.car.TIME_STEP, 45)
